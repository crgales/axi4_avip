...
class axi4_master_agent extends uvm_agent;
  ...
  function void build_phase(uvm_phase phase);
    ...
    if(axi4_master_agent_cfg_h.is_active == UVM_ACTIVE) begin
      ...
      axi4_master_write_seqr_h=axi4_master_sequencer_t::type_id::create("axi4_master_write_seqr_h",this);
      axi4_master_read_seqr_h=axi4_master_sequencer_t::type_id::create("axi4_master_read_seqr_h",this);
    end
