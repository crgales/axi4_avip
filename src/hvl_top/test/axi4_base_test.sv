...
class axi4_base_test extends uvm_test;
  ...
  function void build_phase(uvm_phase phase);
    ...
    setup_axi4_env_cfg(axi4_env_cfg_h);
    uvm_config_db #(axi4_env_config)::set(this,"axi4_env_h","axi4_env_config",axi4_env_cfg_h);
  ...
  //--------------------------------------------------------------------------------------------
  function void setup_axi4_env_cfg(axi4_env_config cfg_h);
  
    cfg_h.no_of_masters = NO_OF_MASTERS;
    cfg_h.no_of_slaves = NO_OF_SLAVES;
  ...
  //--------------------------------------------------------------------------------------------
  // Function: configure_vsequencer
  // Used for configuring the virtual sequencer handles in the test
  // Parameters:
  //  vseq - virtual sequence handle
  //  m_index - master index
  //  s_index - slave index
  //--------------------------------------------------------------------------------------------
  function void configure_vsequencer(axi4_virtual_base_seq vseq, int m_index=0, int s_index=0);
    vseq.axi4_master_write_seqr_h = axi4_env_h.axi4_master_agent_h[m_index].axi4_master_write_seqr_h;
    vseq.axi4_master_read_seqr_h  = axi4_env_h.axi4_master_agent_h[m_index].axi4_master_read_seqr_h;
    vseq.axi4_slave_write_seqr_h  = axi4_env_h.axi4_slave_agent_h[s_index].axi4_slave_write_seqr_h;
    vseq.axi4_slave_read_seqr_h   = axi4_env_h.axi4_slave_agent_h[s_index].axi4_slave_read_seqr_h;
    vseq.env_cfg_h = axi4_env_cfg_h;
  endfunction : configure_vsequencer
